...
$sql2 = "SELECT * FROM village WHERE town_id = '$_SESSION[town_id_sess]'";
$villages = $dbobject->db_query($sql2);
...
<div class="modal-header">
    <h4 class="modal-title" style="font-weight:bold"><?php echo ($operation=="edit")?"Edit ":""; ?>Village Administrator Setup<div><small style="font-size:12px">All asterik fields are compulsory</small></div></h4>
       ...
       <div class="row" style="<?php echo ($operation == "edit")?"display:none":""; ?>">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
              ...
              <div class="col-sm-6">
               <div class="form-group">
                    <label class="form-label">Village<span class="asterik">*</span></label>
                    <select  class="form-control" name="village" id="role_id">
                       <option value="">::SELECT USER VILLAGE::</option>
                        <?php
                        foreach($villages as $row)
                        {
                            $selected = ($user[0]['village'] == $row['village_id'])?"selected":"";
                            echo "<option $selected value='".$row[village_id]."'>".$row['name']."</option>";
                        }
                        ?>
                    </select>
                </div>
