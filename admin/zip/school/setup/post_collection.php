...
$sql_collection_type = "SELECT id,name FROM collection_type";
...
-->
       <div class="row">
           <div class="col-sm-6">
               <div class="form-group">
                   ...
                   <input type="text" id="start_date" name="date_of_collection" class="form-control">
               </div>
           </div>
           <div class="col-sm-6">
               <div class="form-group">
       ...
       <fieldset class="form-group">
          <legend>Collection Basket (&#x20A6;)</legend>
            <?php
           $row_count = 0;
                foreach($collection_type as $row)
                {
