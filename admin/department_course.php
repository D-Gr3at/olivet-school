  ...
  <style>
   ...
   <div class="card">
    <div class="card-header">
        <h5 class="card-title">Department Course List</h5>
    ...
    <div class="card-body">
     <div class="row">
        ...
        ?>
            <div class="col-sm-2">
                <a class="btn btn-warning" onclick="getModal('setup/school_setup.php','modal_div')"  href="javascript:void(0)" data-toggle="modal" data-target="#defaultModalPrimary">
                    Create New Course
                </a>
            </div>
         <?php
