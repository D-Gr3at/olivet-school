...
if(isset($_REQUEST['op']) && $_REQUEST['op'] == 'edit')
{
    ...
    $faculty      = $dbobject->db_query("SELECT * FROM faculty_settup WHERE faculty_id='$faculty_id'");
    $operation = 'edit';
    // echo $faculty[0]['faculty_established'];
}
else
{
    $operation = 'new';
    $query_select_id = "SELECT faculty_id from faculty_settup  ORDER BY faculty_id DESC LIMIT 1";
    $run_query_select_id = $dbobject->db_query($query_select_id);
    $faculty_setup_id = $run_query_select_id[0]["faculty_id"];
    $faculty_id = $faculty_setup_id+1;
}
...
<div class="modal-header">
    <h4 class="modal-title" style="font-weight:bold"><?php echo ($operation=="edit")?"Edit ":""; ?>Faculty Setup<div><small style="font-size:12px">All asterik fields are compulsory</small></div></h4>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                            ...
                            <input type="text" name="faculty_name" value="<?php echo $faculty[0]['faculty_name']; ?>" class="form-control text-uppercase">
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
