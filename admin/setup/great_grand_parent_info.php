...
//    $great_grand_parent_fam_id    = $_REQUEST['great_grand_parent_fam_id'];
    $grand_parent_fam_id    = $_REQUEST['grand_parent_fam_id'];
    $sql_surname = "SELECT surname,id FROM family_name WHERE id = '$id' ";
    $surname     = $dbobject->db_query($sql_surname);
    
    $sql_family_unit = "SELECT family_id,family_head FROM family WHERE family_name = '$id' AND family_id NOT IN('$fam_id','$parent_fam_id','$grand_parent_fam_id') ";
...
// if we find any
$sql = "SELECT great_grand_parent_id FROM family WHERE family_id = '$fam_id' LIMIT 1";
$result = $dbobject->db_query($sql);
if($result[0]['great_grand_parent_id'] != "")
{
...
<div class="modal-header">
    <h4 class="modal-title" style="font-weight:bold">Enter great grand parent for <?php echo $fam_head; ?></h4>
...
<div class="modal-body m-3">
    <form id="form31" onsubmit="return false">
       ...
       <input type="hidden" name="op" value="Family.updateFamilyGreatGrandParent">
       ...
       <div class="row">
           ...
           <div class="col-sm-6">
               <div class="form-group">
                    ...
                    <select name="great_grand_parent_id" id="great_grand_parent_id"  class="form-control">
                        <?php
    ...
    <p><small style="color:red;font-weight: bold;"><span style="color:#000"> NOTE:</span> Close this form and click on "Create Family" button if you can't find <?php echo $fam_head ?>'s great grand parent from the dropdown.</small></p>
</div>
<script>
    function saveRecord()
    {
