...
$sql2 = "SELECT * FROM kindred WHERE village_id = '$_SESSION[village_id_sess]' AND town_id = '$_SESSION[town_id_sess]'";
$kindred = $dbobject->db_query($sql2);
...
elseif($user_role == 3)
{
    $sql_role = "SELECT * FROM role WHERE role_id  = '4'";
}
else
{
...
<div class="modal-header">
    <h4 class="modal-title" style="font-weight:bold"><?php echo ($operation=="edit")?"Edit ":""; ?>Kindred Administrator Setup<div><small style="font-size:12px">All asterik fields are compulsory</small></div></h4>
       ...
       <div class="row" style="<?php echo ($operation == "edit")?"display:none":""; ?>">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
              ...
              <div class="col-sm-6">
               <div class="form-group">
                    <label class="form-label">Kindred<span class="asterik">*</span></label>
                    <select  class="form-control" name="kindred" id="role_id">
                       <option value="">::SELECT USER KINDRED::</option>
                        <?php
                        foreach($kindred as $row)
                        {
                            $selected = ($user[0]['kindred'] == $row['id'])?"selected":"";
                            echo "<option $selected value='".$row[id]."'>".$row['kindred_name']."</option>";
                        }
                        ?>
                    </select>
                </div>
