...
<div class="modal-header">
    <h4 class="modal-title" style="font-weight:bold"><?php echo ($operation=="edit")?"Edit ":""; ?>Staff Setup<div><small style="font-size:12px">All asterik fields are compulsory</small></div></h4>
...
<div class="modal-body m-3 ">
    ...
    <fieldset class="form-group">
        ...
        <div class="col-sm-4">
           ...
           <div class="col-sm-8">
               <div class="form-group">
                    ...
                    <input type="text" name="address" value="<?php echo $user[0]['lastname'] ?>" class="form-control">
                </div>
           </div>
        </div>
        <div class="row">
           ...
           <div class="col-sm-6">
               <div class="form-group">
                    ...
                    <input type="text" id="start_date" autocomplete="off" class="form-control">
                </div>
           </div>
        </div>
        ...
        <div class="row">
           ...
           <div class="col-sm-6">
               <div class="form-group">
                    <label class="form-label">Marital Status<span class="asterik">*</span></label>
    ...
    <fieldset class="form-group">
        ...
        <div class="row">
            <div class="col-sm-6">
               <div class="form-group">
                <label for="">Staff Type<span class="asterik">*</span></label>
                <select name="church_id" id="church_id" class="form-control">
<!--                   <option value=''>::SELECT A CHURCH::</option>-->
                    <?php
                        if($_SESSION['role_id_sess'] == "001" || $_SESSION['role_id_sess'] == "005")
                        {
                            $churc_ses_id = $user[0]['church_id'];
                            $churc_ses_name = $dbobject->getitemlabel('church_table','church_id',$user[0]['church_id'],'church_name');
                            echo "<option selected value='".$churc_ses_id."'>".$churc_ses_name."</option>";
                        }
                        else
                        {
                           echo "<option selected value='".$_SESSION['church_id_sess']."'>".$_SESSION['church_name_sess']."</option>";
                        }
            ...
            <div class="col-sm-6">
               <div class="form-group">
                <label for="">Staff Qualification<span class="asterik">*</span></label>
                <select name="church_id" id="church_id" class="form-control">
<!--                   <option value=''>::SELECT A CHURCH::</option>-->
                    <?php
                        if($_SESSION['role_id_sess'] == "001" || $_SESSION['role_id_sess'] == "005")
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="">Employment Date<span class="asterik">*</span></label>
                    <input type="text" autocomplete="off" id="end_date" class="form-control">
                    
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="">Employment Status<span class="asterik">*</span></label>
