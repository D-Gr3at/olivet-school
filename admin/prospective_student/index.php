...
<body style="background:#fff">
	<div class="wrapper">
		<div class="main">
            ...
            <input type="hidden" id="linkCode" name="linkCode" value="<?php echo($vcode); ?>">
									...
									<div class="timeline-container">
										<ol class="timeline" id="sidebar">
                                            ...
                                            <?php }else if ($admissionstatus == "1"){ ?>
                                                ...
                                                <li id="personal" class="item active">
                                                    <a href="javascript:void(0)" onclick="getpage('acceptance_page.php','page','employment')"  >Acceptance Fee Payment</a>
												</li>
												<!-- <li id="school_fees" class="">
                                                    <a href="javascript:void(0)" onclick="getpage('school_fees.php','page','employment')" >School Fees Payment</a>
												</li> -->
                                                <li id="course_registration" class="item" id="courses">
													<a data-toggle="collapse" href="#course_items" class="collapsed">Courses</a>
													<ul id="course_items" class="list-unstyled collapse " data-parent="#sidebar">
														<li class="option"><a class="link-item" href="javascript:void(0)" onclick="getpage('register_courses.php','page','employment')">Register Courses</a></li>
														<li class="option"><a class="link-item" href="javascript:void(0)" onclick="getpage('view_registered_courses.php','page','employment')">View Registered Courses</a></li>
													</ul>
												</li>
											<?php } else {?>
                                                <li id="bank">
...
<script>
    ...
    function generateSchoolFeesRRR(){
        var link_code = $('#linkCode').val();
        
        $.post("utilities.php",{op:"Payments.schoolFeesRRR",link_code:link_code},function(rr){
					if(rr.response_code == "0"){
						alert(rr.response_message);
						getpage('generste_bank_payment_school_fees.php','page');
					} else {
						alert(rr.response_message);
						// getpage('generste_bank_payment.php','page');
					}
