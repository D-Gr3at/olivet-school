...
echo $_REQUEST['MerchantTransactionID'];
        $result = $dbobject->onePayRequeryCart($_REQUEST['MerchantTransactionID']);
        file_put_contents("resssss.txt",$result);
        echo $result;
        if ($result == '0'){
...
<body><div style="margin:auto; text-align: center;">
        ...
        <div class="card-header">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-4 custom_left">
                    <h5 class="card-title mb-1"><p>Online Acceptance Fee Payment</p></h5>
                </div>
            </div>
	...
	<form action="https://www.onepay.com.ng/api/live/main" method="POST" id="upay" target="onepay_frame" name="upay_form">
	    <input name="product_desc" id="product_desc" type="hidden" value="Acceptance Fee Payment">
	    ...
	    <input name="amt_paid" id="amt_paid" type="hidden" value="10000.00">
	</form>
